...
const CartSideBar = () => {
  ...
  return (
    <div
      ...
      className="pointer-events-auto fixed right-0 top-0 z-50 flex h-[102vh] w-[102vw] flex-col overflow-y-auto border-2 bg-white shadow-lg md:h-screen md:w-[400px]"
    >
